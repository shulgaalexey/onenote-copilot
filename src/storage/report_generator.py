...
from .cache_analyzer import CacheAnalyzer, AnalysisReport
from .storage_optimizer import StorageOptimizer, OptimizationReport
...
<body>
    ...
    def _get_empty_cache_analysis(self, error: str) -> AnalysisReport:
        ...
        from .cache_analyzer import CacheStats, UsagePattern, PerformanceMetrics
    ...
    def _get_empty_storage_analysis(self, error: str) -> OptimizationReport:
        ...
        from .storage_optimizer import StorageStats, OptimizationPlan
